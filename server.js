...
server.listen(port, host, function(){
    ...
    console.log('  POST http://192.168.1.92:' + port + '/api/usuarios/login');
    console.log('  POST http://192.168.1.92:' + port + '/api/usuariosempresa/login');
    console.log('  GET  http://192.168.1.92:' + port + '/api/usuariosempresa/findUsers/:usuario');
});